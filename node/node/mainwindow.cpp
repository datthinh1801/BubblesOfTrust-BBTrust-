...
void MainWindow::on_startButton_clicked()
{
    ...
    qDebug() << blockchain->EncodeFunction(blockchain->EncodeFunctionSelector("BCTrustV2_AddNode(uint8,uint8,uint8,uint256,uint256)"), paramsTypes, paramsValues);
    ...
    qDebug() << blockchain->getMyExternalAddress();
    qDebug() << blockchain->getContractAddress();
    qDebug() << blockchain->EncodeFunction(blockchain->EncodeFunctionSelector("test()"),
                                           paramsTypes,
                                           paramsValues);
